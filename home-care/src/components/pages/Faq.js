...
const Faq = () => {
    return ( <
        ...
        href = "#collapse1" > What kind of service do you provide ? < /a> <
            /h4> <
            /div> <
            div id = "collapse1"
        ...
        data -
        parent = "#accordion"
        href = "#collapse3" > How can I place a service request or a requirement ? < /a> <
        /h4> <
        /div> <
        div id = "collapse3"
        className = "panel-collapse collapse " >
        <
        div className = "panel-body" > You can simply < strong > Call < /strong> or <strong>Watsapp</strong > to our customer care no. < a href = "tell:9888559955" > < strong > 9888 559955 < /strong> </a > or visit our website < a href = "www.jenceo.com//Contact" > jenceo.com / Contact < /a> for placing your service request. We’re available 27/
        7 < /div> <
        /div> <
        /div>
        ...
        a data - toggle = "collapse"
        data - parent = "#accordion"
        href = "#collapse4" > Do you have a Guarantee ? < /a> <
        /h4> <
        /div> <
        div id = "collapse4"
        className = "panel-collapse collapse " >
        ...
        if you have a question or concern about our services, and we will contact you within 24 hours to solve your issue. < /div> <
        /div> <
        /div>
        ...
        a data - toggle = "collapse"
        data - parent = "#accordion"
        href = "#collapse5" > Why should I trust JenCeo Home Care Services ? < /a> <
        /h4> <
        /div> <
        div id = "collapse5"
        className = "panel-collapse collapse " >
        ...
        a data - toggle = "collapse"
        data - parent = "#accordion"
        href = "#collapse6" > Do you have Professionally Workers ? < /a> <
        /h4> <
        /div> <
        div id = "collapse6"
        className = "panel-collapse collapse " >
        <
        div className = "panel-body" > < p >
        JenCeo follows a 3 Step Verification Process
        ...
        a data - toggle = "collapse"
        data - parent = "#accordion"
        href = "#collapse7" > How can I pay ? < /a> <
        /h4> <
        /div> <
        div id = "collapse7"
        className = "panel-collapse collapse " >
